...
export default function StationList() {
    return (
        <Flex wrap='wrap' justify='center'>
            <Card p={4} m={4}>
                <Heading mb={4}>Central Line</Heading>
                <UnorderedList>
            ...
            <Card p={4} m={4}>
                <Heading mb={4}>Harbour Line</Heading>
                <UnorderedList>
            ...
            <Card p={4} m={4}>
                <Heading mb={4}>Western Line</Heading>
                <UnorderedList>
            ...
            <Card p={4} m={4}>
                <Heading mb={4}>Thane Vashi Line</Heading>
                <UnorderedList>
            ...
            <Card p={4} m={4}>
                <Heading mb={4}>Indian Railway</Heading>
                <UnorderedList>
            ...
            <Card p={4} m={4}>
                <Heading mb={4}>Metro Line</Heading>
                <UnorderedList>
                    <ListItem>Ghatkopar</ListItem>
            ...
            <Card p={4} m={4}>
                <Heading mb={4}>Mono Rail Line</Heading>
                <UnorderedList>
                    <ListItem>Chembur</ListItem>
